...
class PDFGenerator:
    ...
    async def _render_to_pdf(self, template_name: str, context: Dict[str, Any], s3_key: str, watermark_text: str = "") -> str:
        ...
        try:
            async with async_playwright() as p:
                ...
                await page.pdf(path=tmp_path, format="A5", margin={"top": "10mm", "bottom": "10mm", "left": "10mm", "right": "10mm"})
                await browser.close()
    ...
    async def generate_invoice(
        ...
        context = self._prepare_context({
            ...
            "items": items or [], "subtotal": subtotal, "tax": tax, "total": total,
            "amount_in_words": amount_in_words, "payment_method": payment_method,
            "upi_id": upi_id, "status": status, "notes": notes,
        }, clinic)
